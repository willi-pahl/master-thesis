...
Alle bekommen die gleichen Fragen aus dem HumanEval-XL Datensatz und werden jeweils zehnmal hintereinander abgefragt. Aus diesen Daten errechnet die \texttt{pass@k} Methodik welche Zuverlässigkeit der Modelle für die Codegenerierung erreichen.
...
%		\hline
		...
		\multicolumn{7}{|l|}{HE-XL: HumanEval-XL} \\
		\hline
	\end{tabular}
